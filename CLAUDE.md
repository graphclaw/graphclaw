...
- PRD: `task-graph-requirements.md` (v1.1, 8500+ lines)
- Review notes: `task-graph-review-notes.md` (28 issues across 6 categories)
...
- LiteLLM (multi-provider skill agent calls)
...
## Current Phase
Phase 0 — Core Loop Proof (see build-plan.md)
