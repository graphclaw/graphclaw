...
class FakeGraphStore(GraphStore):
    ...
    async def create_node(self, node, caller_context: object | None = None) -> dict:
    ...
    async def delete_node(self, node_id: str, caller_context: object | None = None) -> None:
    ...
    async def delete_edge(self, edge_id: str, caller_context: object | None = None) -> None:
