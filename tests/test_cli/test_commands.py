...
class TestTaskList:
    def test_task_list_asyncio_run_called(self):
        with patch("graphclaw.cli.task_commands.run_async") as mock_run:
...
class TestAgentScore:
    def test_agent_score_calls_asyncio_run(self):
        with patch("graphclaw.cli.agent_commands.run_async") as mock_run:
            mock_run.return_value = None
...
class TestGraphCommands:
    def test_graph_stats_calls_asyncio_run(self):
        with patch("graphclaw.cli.graph_commands.run_async") as mock_run:
            mock_run.return_value = None
